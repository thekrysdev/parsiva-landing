    ...
    <section className="px-8 py-28 bg-paper-2">
      <div className="max-w-[1280px] mx-auto">
        <div className="max-w-[720px] mx-auto text-center mb-[72px]">
          <div className="text-xs font-semibold uppercase tracking-[2px] text-p-orange mb-4">FAQ</div>
          <h2 className="font-heading font-medium leading-[1.05] tracking-[-0.025em] text-ink mb-5" style={{ fontSize: "clamp(36px, 4.5vw, 56px)" }}>
            Offene Fragen,
            <br />
            <em className="italic font-normal text-p-blue">ehrliche Antworten.</em>
          </h2>
        </div>
          ...
          {FAQS.map((item, i) => (
            <div key={i} className="border-b border-line py-6">
              ...
              <div
                ...
                style={{ maxHeight: open === i ? "500px" : "0", marginTop: open === i ? "16px" : "0" }}
              >
                {item.a}
              </div>
            </div>
